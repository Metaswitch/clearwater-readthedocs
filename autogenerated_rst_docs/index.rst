...
"`Vulpix <http://pokemon.wikia.com/wiki/Vulpix>`__\ ".
...
If you want to contribute specifically to this documentation (e.g. to
fix a typo or document a missing option), the Markdown files for it are
at https://github.com/Metaswitch/clearwater-readthedocs.
