...
-  For source installs, see the per-component instructions
   (`Sprout/Bono <https://github.com/Metaswitch/sprout/blob/master/docs/Development.html>`__,
   `Ellis <https://github.com/Metaswitch/ellis/blob/master/docs/development.html>`__,
   `Homer/Homestead <https://github.com/Metaswitch/crest/blob/master/docs/development.html>`__).
