...
* A DNS root domain configured as a hosted zone with Route53, this domain will be referred to as `<zone>` in this document.
...
Configure a DNS entry for this machine, `chef-server.<zone>`.
