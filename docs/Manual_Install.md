...
Then upload it to the shared configuration database by running `/usr/share/clearwater/bin/upload_s_cscf_json`. This means that any sprout nodes that you add to the cluster will automatically learn the configuration.
