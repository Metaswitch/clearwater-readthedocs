...
* The number of requests in which a Shared iFC was present which Clearwater had no knowledge of.
* The number of requests which included a service profile which had no applicable iFCs to apply.
* The number of requests on which Default iFCs were looked up to be used, but none were applicable.
